...
def track():
	...
	#operator like airtel, idea, jio, and many more
...
lattitude=Label(root,text="Lattitude: ",bg= "#57adff",fg="black",font=("arial",10,"bold"))
lattitude.place(x=200,y=500)
